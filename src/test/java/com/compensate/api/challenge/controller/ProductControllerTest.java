...
class ProductControllerTest {
    ...
    @Test
    public void getAllShouldReturnCorrectPageFromRequest() throws Exception {
    ...
    private Map<ProductEntity, Product> getMockedProducts() {
        ...
        final Map<String, Object> properties4 = new HashMap<>();
        final Map<String, String> subProperties4 = new HashMap<>();
